...
bool load_content() {
  ...
  meshes["disk"].get_transform().orientation = rotate(mat4(1.0f), half_pi<float>(), vec3(1.0f, 0.0f, 0.0f));
  ...
  meshes["torus"].get_transform().orientation = rotate(quat(), half_pi<float>(), vec3(1.0f, 0.0f, 0.0f));
// *********************************
